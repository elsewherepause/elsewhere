...
export const PATTERNS: Pattern[] = [
  ...
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Caption — landscape', multiline: true },
      { field: 'caption2', label: 'Caption — portrait', multiline: true },
  ...
  },
  {
    ...
    texts: [
      ...
      { field: 'caption3', label: 'Caption — large landscape', multiline: true },
      { field: 'headline', label: 'Headline', multiline: true },
      { field: 'body1', label: 'Body text — left column', multiline: true },
      { field: 'body2', label: 'Body text — right column', multiline: true },
    ],
