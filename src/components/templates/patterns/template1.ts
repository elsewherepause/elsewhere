...
export const PATTERNS: Pattern[] = [
  {
    ...
    texts: [
      { field: 'caption1', label: 'Image caption / subject name', multiline: true },
  ...
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Caption — landscape strip', multiline: true },
      { field: 'caption2', label: 'Caption — small portrait', multiline: true },
      { field: 'caption3', label: 'Caption — tall portrait', multiline: true },
      { field: 'caption4', label: 'Caption — small portrait', multiline: true },
  ...
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Caption — large landscape', multiline: true },
      { field: 'headline', label: 'Headline', multiline: true },
      { field: 'body1', label: 'Body text — left column', multiline: true },
      { field: 'body2', label: 'Body text — right column', multiline: true },
    ],
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Image caption', multiline: true },
      { field: 'headline', label: 'Headline', multiline: true },
      { field: 'body1', label: 'Body text — left column', multiline: true },
      { field: 'body2', label: 'Body text — right column', multiline: true },
    ],
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Caption — tall portrait', multiline: true },
      { field: 'caption2', label: 'Caption — small portrait', multiline: true },
  ...
  },
  {
    ...
    texts: [
      { field: 'caption1', label: 'Caption — top strip', multiline: true },
      { field: 'caption2', label: 'Caption — tall portrait', multiline: true },
      { field: 'caption3', label: 'Caption — bottom strip', multiline: true },
      { field: 'headline', label: 'Headline', multiline: true },
